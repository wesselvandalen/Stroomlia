...
import { getRandomItems } from '../service/product-service.js';
            ...
            <div className="shopping-cart-container">
                <div className="shopping-cart-content">
                    <div className="bag-info-container">
                        ...
                        {cartItems.length === 0 ? <p>Det er ganske stille her...</p> : null }
                    </div>
                    ...
                    <div className="product-detail-view-recommendations">
                        <h3 className='product-detail-view-recommendations-title'>
                            {cartItems.length === 0 ?
                                <>Her er noe inspirasjon for handlekurven din</>
                                :
                                <>Anbefalte produkt for å gjøre handlekurven din perfekt</>
                            }
                        </h3>
