...
export default function ProductDetailView() {
    ...
    function getAvailabilityColor() {
        switch (status) {
            case 'available': return '#2b9b62'; // Grønt
            case 'limited': return '#ecc900'; // Gult
            case 'unavailable': return '#bb0036'; // Rødt
        }
    }
    ...
    function checkAvailability() {
        if (status === "available") {
            ...
            return "Begrenset antall igjen";
        } else {
            return "Ikke på lager";
        }
    }

    function getAvailabilitySVG() {
        switch (status) {
            case 'available': return <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 6L9 17L4 12" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
            </svg>;
            case 'limited': return <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 8V12M12 16H12.01M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
            </svg>;
            case 'unavailable': return <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="product-detail-view-content">
                    ...
                    <div className="product-info-split">
                        <div className="product-detail-view-image-container">
                            <ImageCarousel images={product.imagePaths} altText={product.name} />
                        </div>

                        <div className="product-detail-view-information">

                            <p className='product-availability' style={{ color: getAvailabilityColor() }}>
                                {getAvailabilitySVG()}
                                {checkAvailability()}
                            </p>
                            ...
                            <div className="product-add-button-container">
                                ...
                                />
                                <button className="product-detail-view-button" onClick={handleShoppingButton} disabled={checkAvailability() === 'Ikke på lager'}>
                                    {checkAvailability() === 'Ikke på lager' ?
                                        <>
                                            Ikke på lager
                                        </>
                                        :
